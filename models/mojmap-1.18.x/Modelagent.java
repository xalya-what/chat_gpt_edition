	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(7.0F, -1.0F, -2.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(60, 61)
						.addBox(2.0F, -15.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 58)
						.addBox(-2.0F, -18.0F, -2.0F, 9.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.0F, 19.0F, 0.0F));
